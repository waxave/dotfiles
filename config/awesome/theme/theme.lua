...
-- Ui Fonts
theme.font_name = "Cascadia Code PL "
...
-- Wallpaper
theme.wallpaper = gfs.get_configuration_dir() .. "theme/assets/wallpapers/wallhaven-g8jj5q.png"
theme.pfp = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/brent-blob.png")
